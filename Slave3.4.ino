...
byte movement, fry_release, tilt, mini_launch = false, mini_retract = false, sense;//determines what direction the ROV needs to go
...
{ 
  ...
  thruster_values();//sets up all the variables that will be used in the thrusteers_go
